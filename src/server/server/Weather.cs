...
/*
 * http://api.map.baidu.com/telematics/v3/weather?location=深圳&output=json&ak=YdrtIvuTE25sNvAmxS05DgEo
 * http://api.map.baidu.com/telematics/v3/weather?location=116.305145,39.982368|122.305145,36.982368&output=json&ak=YdrtIvuTE25sNvAmxS05DgEo
...
/*
 * http://api.map.baidu.com/place/v2/search?q=深圳&region=深圳&output=json&ak=YdrtIvuTE25sNvAmxS05DgEo
 * 
 * {
    "status":0,
    "message":"ok",
